<?php require './menu.php'; ?>
            ...
            <section class="principal">
                ...
                <div class="coluna">
                    <figure class="foto"><img src="img/foto-02.png"></figure>
                        <h2> Estude torne-se um especialista em PHP.</h2>
                ...
                <div class="coluna">
                    <figure class="foto"><img src="img/foto-04.png"></figure>
